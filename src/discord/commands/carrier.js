...
module.exports = {
  ...
  execute: async (interaction, client) => {
    ...
    const terms = new EmbedBuilder()
      .setDescription("# Demandes de service")
      .addFields({
        name: "\u200b",
        value:
    ...
    const floor = new EmbedBuilder()
      .setDescription("# Exigences du carry Floor")
      .addFields({
        name: "\u200b",
        value:
    ...
    const master = new EmbedBuilder()
      .setDescription("# Exigences du carry Master")
      .addFields({
        name: "\u200b",
        value:
    ...
    const slayer = new EmbedBuilder()
      .setDescription("# Exigences du carry Slayer")
      .addFields({
        name: "\u200b",
        value:
    ...
    const kuudra = new EmbedBuilder()
      .setDescription("# Exigences du carry Kuudra")
      .addFields({
        name: "\u200b",
        value:
