  ...
  execute: async (interaction, client) => {
    ...
    const terms = new EmbedBuilder()
      .addFields({
        ...
        value:
          "Pour postuler à un rôle de service, réagissez avec 'Créer votre ticket' Veuillez noter que vous DEVEZ être vérifié pour postuler aux rôles de service. Suivez les étapes de <#1017785843458506822> si vous ne l'avez pas déjà fait avant de postuler.",
      })
      .setFooter({
        text: "FrenchLegacy",
