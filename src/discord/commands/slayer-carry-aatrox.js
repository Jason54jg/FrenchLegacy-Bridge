...
module.exports = {
  ...
  execute: async (interaction, client) => {
    ...
    const important = new EmbedBuilder()
      .addFields({
        name: "⚠️ Informations importantes pour les clients ⚠️",
        value:
