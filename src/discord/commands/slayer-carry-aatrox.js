...
module.exports = {
    ...
    execute: async (interaction, client) => {
        ...
        const aatrox = new EmbedBuilder()
            .addFields({ name: 'Informations pour Aatrox', value: "Exceptionnellement nous avons augmenté les prix des carrys pendant Aatrox de 20%" })
            .setFooter({ text: "FrenchLegacy", iconURL: `https://media.discordapp.net/attachments/1073744026454466600/1076983462403264642/icon_FL_finale.png` });
