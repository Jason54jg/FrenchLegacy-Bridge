            ...
            hypixel.getPlayer(username).then(async player => {
                ...
                if (found) {
                    ...
                    const verificationTutorialEmbed = new EmbedBuilder()
                        .setAuthor({ name: 'Ajoute ton hashtag discord dans le menu social de hypixel', iconURL: 'https://cdn.discordapp.com/avatars/486155512568741900/164084b936b4461fe9505398f7383a0e.png?size=4096' })
