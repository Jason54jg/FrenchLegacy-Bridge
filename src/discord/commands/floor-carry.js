...
module.exports = {
  ...
  execute: async (interaction, client) => {
		...
		.setAuthor({ name: 'Floor 1', iconURL: 'https://cdn.discordapp.com/emojis/1039705817252909147.png'})
        .setThumbnail('https://cdn.discordapp.com/emojis/1039705817252909147.png')
        .addFields(
            { name: 'Completion', value: '- 1 Run: 90k\n- 5 ou plus: 70k/unité', inline: true },
            { name: 'S Runs', value: '- 1 Run: 120k\n- 5 ou plus: 100k/unité', inline: true },
        )
        .setFooter({text: "FrenchLegacy", iconURL: "https://media.discordapp.net/attachments/1073744026454466600/1076983462403264642/icon_FL_finale.png"});

        const floor2 = new EmbedBuilder()
		.setAuthor({ name: 'Floor 2', iconURL: 'https://cdn.discordapp.com/emojis/1039705859518910634.png'})
        .setThumbnail('https://cdn.discordapp.com/emojis/1039705859518910634.png')
        .addFields(
            { name: 'Completion', value: '- 1 Run: 170k\n- 5 ou plus: 150k/unité', inline: true },
            { name: 'S Runs', value: '- 1 Run: 250k\n- 5 ou plus: 210k/unité', inline: true },
        )
        .setFooter({text: "FrenchLegacy", iconURL: "https://media.discordapp.net/attachments/1073744026454466600/1076983462403264642/icon_FL_finale.png"});

        const floor3 = new EmbedBuilder()
		.setAuthor({ name: 'Floor 3', iconURL: 'https://cdn.discordapp.com/emojis/1039705994768425050.png'})
        .setThumbnail('https://cdn.discordapp.com/emojis/1039705994768425050.png')
        .addFields(
            { name: 'Completion', value: '- 1 Run: 280k\n- 5 ou plus: 260k/unité', inline: true },
            { name: 'S Runs', value: '- 1 Run: 350k\n- 5 ou plus: 300k/unité', inline: true },
        )
        .setFooter({text: "FrenchLegacy", iconURL: "https://media.discordapp.net/attachments/1073744026454466600/1076983462403264642/icon_FL_finale.png"});
        ...
        .addFields(
            { name: 'Completion', value: '- 1 Run: 400k\n- 5 ou plus: 340k/unité', inline: true },
            { name: 'S Runs', value: '- 1 Run: 600k\n- 5 ou plus: 510k/unité', inline: true },
        )
        .setFooter({text: "FrenchLegacy", iconURL: "https://media.discordapp.net/attachments/1073744026454466600/1076983462403264642/icon_FL_finale.png"});
        ...
        .addFields(
            { name: 'Completion', value: '- 1 Run: 350k\n- 5 ou plus: 300k/unité', inline: true },
            { name: 'S Runs', value: '- 1 Run: 500k\n- 5 or more Runs: 425k/unité', inline: true },
            { name: 'S+ Runs', value: '- 1 Run: 800k\n- 5 ou plus: 680k/unité', inline: true },
        )
        .setFooter({text: "FrenchLegacy", iconURL: "https://media.discordapp.net/attachments/1073744026454466600/1076983462403264642/icon_FL_finale.png"});
        ...
        .addFields(
            { name: 'Completion', value: '- 1 Run: 600k\n- 5 ou plus: 510k/unité', inline: true },
            { name: 'S Runs', value: '- 1 Run: 850k\n- 5 ou plus: 725k/unité', inline: true },
            { name: 'S+ Runs', value: '- 1 Run: 1.1m\n- 5 ou plus: 850k/unité', inline: true },
        )
        .setFooter({text: "FrenchLegacy", iconURL: "https://media.discordapp.net/attachments/1073744026454466600/1076983462403264642/icon_FL_finale.png"});
        ...
        .addFields(
            { name: 'Completion', value: '- 1 Run: 4m\n- 5 ou plus: 3.4m/unité', inline: true },
            { name: 'S Runs', value: '- 1 Run: 8m\n- 5 ou plus: 6.8m/unité', inline: true },
            { name: 'S+ Runs', value: '- 1 Run: 10m\n- 5 ou plus: 8.5m/unité', inline: true },
        )
        .setFooter({text: "FrenchLegacy", iconURL: "https://media.discordapp.net/attachments/1073744026454466600/1076983462403264642/icon_FL_finale.png"});
		...
		interaction.channel.send({embeds: [terms, conditions, floor1, floor2, floor3, floor4, floor5, floor6, floor7, service],
            components: [
