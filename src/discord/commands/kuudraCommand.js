...
module.exports = {
  ...
  execute: async (interaction, client, InteractionCreate) => {
    ...
    const waves = [
      "highest_wave_none",
      "highest_wave_hot",
      "highest_wave_burning",
      "highest_wave_fiery",
      "highest_wave_infernal",
    ];
    ...
    const pfmess =
      raw.nether_island_player_data.kuudra_party_finder.group_builder.note ??
      "Paper";
    const pft =
      raw.nether_island_player_data.kuudra_party_finder.group_builder.tier ??
      "basic";
    const pfreq =
      raw.nether_island_player_data.kuudra_party_finder.group_builder
