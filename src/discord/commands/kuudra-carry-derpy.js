...
module.exports = {
  name: "kuudracarryderpy",
  description: `Commande pour les embeds des kuudra pour derpy`,
  ...
  execute: async (interaction) => {
    ...
    const kuudra1 = new EmbedBuilder()
      ...
      .addFields({ name: "Runs", value: "- 1 Run: 7.5m\n- 5 ou plus: 6m/unité" })
      .setFooter({
        text: "FrenchLegacy",
        iconURL: `https://media.discordapp.net/attachments/1073744026454466600/1076983462403264642/icon_FL_finale.png`,
      });
    ...
    const kuudra2 = new EmbedBuilder()
      ...
      .setThumbnail("https://cdn.discordapp.com/emojis/1049723395740274709.png")
      .addFields({ name: "Runs", value: "- 1 Run: 13.5m\n- 5 ou plus: 10.5m/unité" })
      .setFooter({
        text: "FrenchLegacy",
        iconURL: `https://media.discordapp.net/attachments/1073744026454466600/1076983462403264642/icon_FL_finale.png`,
      });
