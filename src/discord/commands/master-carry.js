...
module.exports = {
  ...
  execute: async (interaction) => {
    ...
    const service = new EmbedBuilder()
      .setDescription("# Services de carry donjon (Master Mode)")
      .addFields({
        name: "\u200b",
        value:
