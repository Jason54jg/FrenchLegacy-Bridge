...
class JacobCommand extends minecraftCommand {
    constructor(minecraft) {
        ...
        this.description = "Statistiques du concours de Jacob de l'utilisateur spécifié.";
        this.options = [];
    }
    ...
    async onCommand(username, message) {
        try {
            ...
            this.send(
                `/gc Médailles d'or de ${username}: ${profile.medals.gold} | Silver: ${profile.medals.silver} | Bronze: ${profile.medals.bronze} | Personal Bests: ${profile.perks.personalBests ? "has" : "missing"} | Double Drops ${profile.perks.doubleDrops}/15 | Level Cap: ${profile.perks.levelCap}/10`,
            );
