...
| guildtop     | Top 10 des membres avec le plus d'xp de guilde. | `/guildtop [entier]`        | `/guildtop 5`                       | ![](https://imgur.com/7oV77ey.png) |
| help         | Affiche le menu d'aide. | `/aide`                     | `/aide`                             | ![](https://imgur.com/CLka3pQ.png) |
